...
$sourceurl = "http://www.swishersolutions.com/routemanager/";

$location_name = "DIA";

$location_name_long = "Denver International Airport (DIA)";

$pathforfiles =  "../../routemanagerdocs/abmdia";
$pathfortempfiles =  "../../routemanagerdocs/abmdia/temp";
...
$dbconn = new PDO('mysql:host=localhost;dbname=abmroutemanager', 'abm', ' jkkjgJHkjjhgf8-098&890nghjgHJ', array(PDO::ATTR_PERSISTENT => true
));
		...
		echo '<nav class="navbar navbar-fixed-top nav" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<h2>
						<a href="./"><img src="img/logo.png" /></a>
						Route<span style="visibility:hidden;">.</span>Manager
...
function headermarkup($title) {
	...
	<head>
		...
		<title>' . $title . '</title>
		<meta name="description" content="ABM DIA Route Manager" />
	...
	return '<div class="footer navbar-fixed-bottom">
		<footer>
			<div class="row" style="padding:0 10px 0 10px;background-color:white;">
				<div class="col-xs-6">&copy; ABM DIA 2018</div>
